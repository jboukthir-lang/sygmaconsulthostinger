...
export const translations = {
  ...
  admin: {
    ...
    services: {
      ...
      moveUp: { fr: 'Déplacer vers le haut', ar: 'تحريك للأعلى', en: 'Move up' },
      moveDown: { fr: 'Déplacer vers le bas', ar: 'تحريك للأسفل', en: 'Move down' },
      image: { fr: 'Image du service', ar: 'صورة الخدمة', en: 'Service Image' },
      optional: { fr: '(optionnel)', ar: '(اختياري)', en: '(optional)' },
      noImage: { fr: 'Pas d\'image', ar: 'لا توجد صورة', en: 'No image' },
      changeImage: { fr: 'Changer l\'image', ar: 'تغيير الصورة', en: 'Change image' },
      uploadImage: { fr: 'Télécharger une image', ar: 'تحميل صورة', en: 'Upload image' },
      uploadSuccess: { fr: 'Téléchargé avec succès', ar: 'تم التحميل بنجاح', en: 'Uploaded successfully' },
      saveService: { fr: 'Enregistrer le service', ar: 'حفظ الخدمة', en: 'Save Service' },
      url: { fr: 'URL du service', ar: 'رابط الخدمة', en: 'Service URL' },
      languages: {
        en: { fr: 'Anglais', ar: 'الإنجليزية', en: 'English' },
        fr: { fr: 'Français', ar: 'الفرنسية', en: 'French' },
        ar: { fr: 'Arabe', ar: 'العربية', en: 'Arabic' },
      },
    },
    monthlyOverview: {
      fr: 'Aperçu mensuel',
    ...
    partners: {
      title: { fr: 'Partenaires & Clients', ar: 'الشركاء والعملاء', en: 'Partners & Clients' },
      subtitle: { fr: 'Gérer les logos des partenaires affichés', ar: 'إدارة شعارات الشركاء المعروضة', en: 'Manage displayed partners and client logos' },
      new: { fr: 'Nouveau partenaire', ar: 'شريك جديد', en: 'New Partner' },
      name: { fr: 'Nom de l\'entreprise', ar: 'اسم الشركة', en: 'Company Name' },
      website: { fr: 'Site Web (Optionnel)', ar: 'الموقع الإلكتروني (اختياري)', en: 'Website URL (Optional)' },
      logo: { fr: 'Logo du partenaire', ar: 'شعار الشريك', en: 'Partner Logo' },
      uploadLogo: { fr: 'Télécharger le logo', ar: 'تحميل الشعار', en: 'Upload Logo' },
      changeLogo: { fr: 'Changer le logo', ar: 'تغيير الشعار', en: 'Change Logo' },
      active: { fr: 'Actif (Visible)', ar: 'نشط (مرئي)', en: 'Active (Visible)' },
      inactive: { fr: 'Inactif (Masqué)', ar: 'غير نشط (مخفي)', en: 'Inactive (Hidden)' },
      noPartners: { fr: 'Aucun partenaire trouvé', ar: 'لم يتم العثور على شركاء', en: 'No partners found' },
      deleteConfirm: { fr: 'Êtes-vous sûr de vouloir supprimer ce partenaire ?', ar: 'هل أنت متأكد من حذف هذا الشريك؟', en: 'Are you sure you want to delete this partner?' },
      searchPlaceholder: { fr: 'Rechercher des partenaires...', ar: 'بحث عن شركاء...', en: 'Search partners...' },
      total: { fr: 'Total:', ar: 'الإجمالي:', en: 'Total:' },
      recommended: { fr: 'Recommandé: PNG transparent, 400x200px', ar: 'الموصى به: PNG شفاف، 400x200 بكسل', en: 'Recommended: Transparent PNG, 400x200px' },
    },
    settings: {
      title: { fr: 'Paramètres du site', ar: 'إعدادات الموقع', en: 'Site Settings' },
      subtitle: { fr: 'Gérer les informations de l\'entreprise et la marque', ar: 'إدارة معلومات الشركة والعلامة التجارية', en: 'Manage company information and branding' },
      save: { fr: 'Enregistrer les modifications', ar: 'حفظ التغييرات', en: 'Save Changes' },
      saving: { fr: 'Enregistrement...', ar: 'جاري الحفظ...', en: 'Saving...' },
      tabs: {
        company: { fr: 'Informations', ar: 'معلومات الشركة', en: 'Company Info' },
        contact: { fr: 'Contact', ar: 'التواصل', en: 'Contact Info' },
        social: { fr: 'Réseaux sociaux', ar: 'وسائل التواصل', en: 'Social Media' },
        branding: { fr: 'Marque & Couleurs', ar: 'العلامة التجارية', en: 'Branding & Colors' },
      },
      companyName: { fr: 'Nom de l\'entreprise', ar: 'اسم الشركة', en: 'Company Name' },
      tagline: { fr: 'Slogan', ar: 'الشعار النصي', en: 'Tagline' },
      description: { fr: 'Description', ar: 'الوصف', en: 'Description' },
      primaryPhone: { fr: 'Téléphone principal', ar: 'الهاتف الرئيسي', en: 'Primary Phone' },
      secondaryPhone: { fr: 'Téléphone secondaire', ar: 'الهاتف الثانوي', en: 'Secondary Phone' },
      whatsapp: { fr: 'Numéro WhatsApp', ar: 'رقم واتساب', en: 'WhatsApp Number' },
      primaryEmail: { fr: 'Email principal', ar: 'البريد الإلكتروني الرئيسي', en: 'Primary Email' },
      secondaryEmail: { fr: 'Email secondaire', ar: 'بريد إلكتروني ثانوي', en: 'Secondary Email' },
      address: { fr: 'Adresse', ar: 'العنوان', en: 'Address' },
      businessHours: { fr: 'Heures d\'ouverture', ar: 'ساعات العمل', en: 'Business Hours' },
      socialLinks: { fr: 'Liens sociaux', ar: 'روابط التواصل', en: 'Social Links' },
      primaryColor: { fr: 'Couleur principale', ar: 'اللون الأساسي', en: 'Primary Color' },
      secondaryColor: { fr: 'Couleur secondaire', ar: 'اللون الثانوي', en: 'Secondary Color' },
      preview: { fr: 'Aperçu', ar: 'معاينة', en: 'Preview' },
      logo: { fr: 'Logo du site', ar: 'شعار الموقع', en: 'Site Logo' },
      favicon: { fr: 'Favicon', ar: 'أيقونة الموقع', en: 'Favicon' },
      upload: { fr: 'Télécharger', ar: 'تحميل', en: 'Upload' },
      change: { fr: 'Changer', ar: 'تغيير', en: 'Change' },
      warning: { fr: 'Attention: Changer les couleurs affectera tout le site.', ar: 'تنبيه: تغيير الألوان سيؤثر على كامل الموقع.', en: 'Warning: Changing colors will affect the entire site.' },
    },
    totalBookings: {
      fr: 'Total des réservations',
      ar: 'إجمالي الحجوزات',
